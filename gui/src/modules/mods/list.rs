...
impl ModList {
    ...
    fn render_top_panel(&mut self, ui: &mut egui::Ui, state: &mut ModDataState) {
        ui.scope(|ui| {
    ...
    fn update_search_cache(&mut self, state: &ModDataState, query: &str) {
    ...
    fn render_list_row(&mut self, ui: &mut egui::Ui, state: &mut ModDataState, real_index: usize) {
