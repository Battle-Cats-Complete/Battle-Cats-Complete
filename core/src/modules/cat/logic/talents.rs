...
use crate::modules::cat::registry::{get_display_def, CAT_STATS_REGISTRY};
...
pub fn calculate_talent_display(
    ...
    let leveled_base_stats = crate::modules::cat::logic::stats::apply_level(base_stats, level_curve, unit_level);
