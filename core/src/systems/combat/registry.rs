...
pub fn get_display_def(identity: Identity, faction: Faction) -> AbilityDisplayDef {
    match identity {
        Identity::TraitRed => AbilityDisplayDef {
            name: pick(faction, "Target Red", "Red"),
            fallback: "Red",
        ...
        Identity::TraitFloating => AbilityDisplayDef {
            name: pick(faction, "Target Float", "Floating"),
            fallback: "Float",
        ...
        Identity::TraitDark => AbilityDisplayDef {
            name: pick(faction, "Target Dark", "Dark"),
            fallback: "Dark",
        ...
        Identity::TraitMetal => AbilityDisplayDef {
            name: pick(faction, "Target Metal", "Metal"),
            fallback: "Metal",
        ...
        Identity::TraitTraitless => AbilityDisplayDef {
            name: pick(faction, "Target Traitless", "Traitless"),
            fallback: pick(faction, "NoTrt", "White"),
        ...
        Identity::TraitAngel => AbilityDisplayDef {
            name: pick(faction, "Target Angel", "Angel"),
            fallback: "Angel",
        ...
        Identity::TraitAlien => AbilityDisplayDef {
            name: pick(faction, "Target Alien", "Alien"),
            fallback: "Alien",
        ...
        Identity::TraitZombie => AbilityDisplayDef {
            name: pick(faction, "Target Zombie", "Zombie"),
            fallback: "Zomb",
        ...
        Identity::TraitRelic => AbilityDisplayDef {
            name: pick(faction, "Target Relic", "Relic"),
            fallback: "Relic",
        ...
        Identity::TraitAku => AbilityDisplayDef {
            name: pick(faction, "Target Aku", "Aku"),
            fallback: "Aku",
        ...
        Identity::TraitWitch => AbilityDisplayDef {
            name: pick(faction, "Target Witch", "Witch"),
            fallback: "Witch",
            icon: AbilityIcon::Standard(img015::ICON_WITCH),
            group: pick(faction, DisplayGroup::Trait, DisplayGroup::Headline1),
            formatter: |ctx| side(ctx, "Targets Witch Enemies", "Witch Enemy"),
        },
        Identity::TraitEva => AbilityDisplayDef {
            name: pick(faction, "Target EVA", "EVA Angel"),
            fallback: "EVA",
        ...
        Identity::TraitDojo => AbilityDisplayDef {
            ...
            group: pick(faction, DisplayGroup::Hidden, DisplayGroup::Headline1),
        ...
        Identity::AttackOnly => AbilityDisplayDef {
            ...
            group: pick(faction, DisplayGroup::Headline1, DisplayGroup::Hidden),
        ...
        Identity::Conjure => AbilityDisplayDef {
            ...
            group: pick(faction, DisplayGroup::Body1, DisplayGroup::Hidden),
        ...
        Identity::DeathSurge => AbilityDisplayDef {
            ...
            group: pick(faction, DisplayGroup::Hidden, DisplayGroup::Body1),
            formatter: |ctx| format!(
                "{}% Chance to create a Level {} Surge\n{} Range upon death",
                finite(ctx.value),
        ...
        Identity::Barrier => AbilityDisplayDef {
            ...
            group: pick(faction, DisplayGroup::Hidden, DisplayGroup::Body2),
        ...
        Identity::ImmuneToxic => AbilityDisplayDef {
            ...
            group: pick(faction, DisplayGroup::Footer, DisplayGroup::Hidden),
...
pub fn get_fallback_by_icon(target_icon: AbilityIcon, faction: Faction) -> &'static str {
    REGISTRY.iter()
        .map(|pure_definition| get_display_def(pure_definition.identity, faction))
